...
```
var TextAnalyzer = require('atropa-TextAnalyzer').TextAnalyzer;
console.log(TextAnalyzer);
```

In the browser this module is attached to the global namespace `atropa`, which
 will be created if it does not exist.
 Include `./browser/atropa-TextAnalyzer_web.js` in your page and
 `atropa.TextAnalyzer` will be available in your page.
...
To run the browser tests open `browser/atropa-TextAnalyzer_tests.html` in your
...
If you alter the source in `src/atropa-TextAnalyzer.js` please run the
